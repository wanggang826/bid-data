...
class WxPayDataBase
{
	...
	**/
	public function ToXml()
	{
        ...
        //如果子商户公众号id为空，则说明不是服务商，则销毁对应key
    	if( isset($this->values['sub_appid']) && empty($this->values['sub_appid']) )
        {
            unset($this->values['sub_appid']);
        }

        //如果子商户id为空，则说明不是服务商，则销毁对应key
        if( isset($this->values['sub_mch_id']) && empty($this->values['sub_mch_id']) )
        {
            unset($this->values['sub_mch_id']);
        }
...
{	
	...
	**/
    ...
    {
        $this->values['sub_mch_id'] = $subMerchantId;
        return $this;
    }
